...
public class Contacts extends AppCompatActivity {
    ...
    DataBaseHelper dataBaseHelper = new DataBaseHelper(Contacts.this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contacts);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setBackgroundDrawable(getResources().getDrawable(R.drawable.gradient_background4));
        ...
        if((requestCode==1) && (resultCode==RESULT_OK))
        {
            try{
                ...
                if(cursor != null && cursor.moveToNext())
                {
                    ...
                    Toast.makeText(Contacts.this,ToastMsg,Toast.LENGTH_SHORT).show();
                }
            }
            catch (Exception e)
            {
